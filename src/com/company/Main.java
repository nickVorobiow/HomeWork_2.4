...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        car1.setSeasonTyres(1);
        car2.setSeasonTyres(1);
        car3.setSeasonTyres(1);
        car4.setSeasonTyres(1);
        car5.setSeasonTyres(1);
